    ...
    <>
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        <div 
          ...
          style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1661089209976-45c2cbcb24e9?q=80&w=2000&auto=format&fit=crop')",
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center mb-20">
            ...
            <div className="bg-slate-100 rounded-3xl h-[500px] overflow-hidden relative">
                 <div 
                  ...
                  style={{
                    backgroundImage: "url('https://images.unsplash.com/photo-1596522512683-11a3d9021669?q=80&w=2070&auto=format&fit=crop')"
                  }}
                 />
            </div>
          </div>
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { title: 'Verleih (1 Std)', price: '15€', duration: '60 Minuten', features: ['Board & Paddel', 'Schwimmweste', 'Kurze Einweisung'], targetId: 'sup-rent-1h', type: 'rental' },
                { title: 'Einsteigerkurs', price: '39€', duration: '90 Minuten', features: ['Technik-Grundlagen', 'Sicherheits-Check', 'Betreute Tour'], popular: true, targetId: 'sup-basic', type: 'course' },
                { title: 'Sunset Tour', price: '29€', duration: 'ca. 2 Stunden', features: ['Geführte Tour', 'Sonnenuntergang', 'Getränk inklusive'], targetId: 'sup-tour', type: 'course' },
              ].map((item) => (
                <div key={item.title} className={`bg-white dark:bg-slate-900 p-8 rounded-3xl border ${item.popular ? 'border-cyan-500 shadow-xl scale-105' : 'border-slate-200 dark:border-slate-800'} relative`}>
                  ...
                  <div className="text-4xl font-bold text-cyan-600 mb-2">{item.price}</div>
